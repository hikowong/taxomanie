...
urlpatterns += patterns('phylocore.views',
    ...
    (r'^phyloexplorer/get_image_tree_url/(?P<idtree>.*)$', 'get_image_tree_url'),
    (r'^phyloexplorer/get_image_reference_tree_url/(?P<idtree>.*)$', 'get_image_reference_tree_url'),
    ...
    (r'^phyloexplorer/downloadNCBITree$', 'downloadNCBITree'),
