	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage	: '/site_media/progressbar.gif',		// boxImage : image around the progress bar
				barImage	: '/site_media/progressbg_green.gif',	// Image to use in the progressbar. Can be an array of images too.
